...
public class TrackedDeviceBateryLevel{
    ...
    public static final int TrackedDeviceBateryLevel_Middle = 2;
    public static final int TrackedDeviceBateryLevel_High = 3;
    public static final int TrackedDeviceBateryLevel_Max = 4;
}
